...
page_options = ["Home", "FlixWhiz Info", "Recommender System","Analysis", "About Us", "Feedback"]
...
if page_selection == "Analysis":
        ...
        st.header('Discovering the most viewed movie genres')
        st.write('In the graph below, we explore the movie dataset to gain insights into the most viewed movie genres. '
         'By analyzing the most popular genres, we aim to understand the audience\'s preferences and trends in the movie industry.')
        st.image('resources/imgs/genres.png')
        st.write('The graph reveals that "Drama" is the most prevalent genre, followed by "Comedy" and "Thriller." '
                 "Users can quickly grasp the popularity of different movie genres within the app's community, encouraging them to explore movies in those genres.")
        st.write('The dataset provides valuable insights into the distribution of movie genres, which can inform future movie recommendations and content curation.')

        st.header("Exploring the top 15 most popular movies by ratings")
        st.write('By analyzing the highest-rated movies, we aim to identify the audience\'s favorite films and understand what contributes to their popularity.')
        st.image("resources/imgs/top15.png")
        st.write('The graph highlights the movies that have resonated the most with the audience, receiving exceptional ratings from users, with "SHawshank Redemption" and "Forest Gump" topping the chart. '
         "Recommending popular movies with high ratings increases the likelihood of user satisfaction.")
        st.write(" Users are more likely to enjoy movies that have received positive acclaim, leading to a positive experience with the app."
         'These top-rated films can provide valuable insights into the features and elements that contribute to a movie\'s success and appeal.')   

        st.header("Unveiling the Top 5 Directors with the Most Movies")
        st.write('Below we explore the movie dataset to identify the top 5 directors who have directed the most movies. '
         'By analyzing the prolific directors, we aim to recognize the filmmakers who have made a significant impact on the movie industry.')
        st.image("resources/imgs/direct.png")
        st.write('This chart sheds light on the directors who have made a considerable impact on the movie world. '
         'By understanding the breadth and depth of their filmography, we can gain insights into the variety of genres and styles they have explored.'
         "Incorporating data on top directors can influence the app's recommendations. If a user enjoys a movie from a specific director, the recommender system can suggest other movies directed by the same filmmaker.")
