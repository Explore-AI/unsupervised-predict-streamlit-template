...
def main():
    ...
    if page_selection == "About Us":
        ...
        st.write("We are a team of data scientists passionate about giving you the best movie experience.")
        ...
        col3.image("resources/imgs/sm.jpg", caption="Chief Administrative Officer", width=200)
        ...
        col4.image("resources/imgs/os.jpg", caption="Senior Developer", width=200)
    ...
    if page_selection == "Movie Mate":
        # Header contents
        st.write('# Movie Mate Recommender')
