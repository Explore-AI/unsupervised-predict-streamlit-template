...
def main():
	...
	if page_selection == 'About':
		with st.container():
			...
			st.write(
					"""
					Elite Consulting was founded in 1995 by some of the brightest minds at Silicon Valley’s leading companies, Some of our clients include Google, Yahoo!, Oracle, and Facebook. 
